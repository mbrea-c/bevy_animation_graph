...
const _: () = {
        ...
        fn type_info() -> &'static ::bevy::reflect::TypeInfo {
            ...
            CELL.get_or_set(|| {
                ::bevy::reflect::TypeInfo::TupleStruct(
                    ::bevy::reflect::TupleStructInfo::new::<Self>(&[
    ...
    impl ::bevy::reflect::TypePath for DynNodeLike {
        ...
        fn type_ident() -> Option<&'static str> {
            ::core::option::Option::Some("DynNodeLike")
        }
    ...
    impl ::bevy::reflect::PartialReflect for DynNodeLike {
        ...
        > {
            ::core::result::Result::Ok(::bevy::reflect::__macro_exports::alloc_utils::Box::new(
                Self(self.0.clone_node_like()),
            ))
        }
    }
